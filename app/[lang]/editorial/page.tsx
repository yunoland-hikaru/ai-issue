...
const EDITORIAL: Record<Language, { title: string; blocks: LegalBlock[] }> = {
  ja: {
    ...
    blocks: [
      ...
      { t: 'h2', text: '記事の作り方' },
      { t: 'p', text: '信頼できる公開情報源（RSSなど）からニュースを収集し、AIが日本語・韓国語・英語で要約・再構成します。単なる翻訳ではなく、背景や文脈、意味合いを補った解説スタイルで作成します。' },
      { t: 'h2', text: '出典と透明性' },
  ...
  ko: {
    ...
    blocks: [
      ...
      { t: 'h2', text: '기사 제작 방식' },
      { t: 'p', text: '신뢰할 수 있는 공개 정보원(RSS 등)에서 뉴스를 수집하고, AI가 한국어·일본어·영어로 요약·재구성합니다. 단순 번역이 아니라 배경과 맥락, 의미를 더한 해설 형태로 작성합니다.' },
      { t: 'h2', text: '출처와 투명성' },
  ...
  en: {
    ...
    blocks: [
      ...
      { t: 'p', text: 'We gather news from reputable public sources (such as RSS), and AI summarizes and restructures it in Japanese, Korean, and English. Rather than a simple translation, articles are written in an explanatory style that adds background, context, and significance.' },
